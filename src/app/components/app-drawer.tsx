 ...
 *
 * Exemplo de uso:
 *   <AppDrawer currentAppId="dsh" onNavigate={(route) => navigate(route)} onClose={() => setOpen(false)} />
 *
        ...
        {zeniteAddons.map((addon, index) => {
          ...
          return (
            <motion.button
              ...
              className="flex flex-col items-center gap-1.5 py-3 px-2 rounded-[12px] transition-colors hover:bg-[#F6F7F9]"
              disabled={isDisabled}
