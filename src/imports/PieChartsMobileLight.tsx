...
import svgPaths from "./svg-xbru0tgewu";
type Wrapper2Props = {
...
function PieChartsMobileLightSubtract() {
  return (
    <Wrapper1>
...
function PieChartsMobileLightHelper() {
  return (
    <div className="relative size-full">
      <Wrapper1>
        <path d={svgPaths.p54ed1c0} fill="var(--fill-0, #D3DDE7)" id="Subtract" />
      </Wrapper1>
    </div>
  );
}
type PieChartsMobileLight16SpBodyTextProps = {
  text: string;
  additionalClassNames?: string;
};

function PieChartsMobileLight16SpBodyText({ text, additionalClassNames = "" }: PieChartsMobileLight16SpBodyTextProps) {
  return (
    <div className={clsx("-translate-x-1/2 -translate-y-1/2 absolute h-[24px] opacity-80 w-[156px]", additionalClassNames)}>
      <div className="absolute flex flex-col font-['IBM_Plex_Sans:Regular',sans-serif] inset-0 justify-center leading-[0] not-italic text-[#263238] text-[16px] text-center tracking-[0.44px]">
...
function PieChartsMobileLightFill() {
  return (
    <Wrapper2 additionalClassNames="absolute inset-0 mix-blend-difference">
      <g id="Fill" style={{ mixBlendMode: "difference" }}>
        <path d={svgPaths.p3972770} fill="var(--fill-0, #CFBEF0)" />
      </g>
    </Wrapper2>
  );
}
type PieChartsMobileLightTextProps = {
  text: string;
  additionalClassNames?: string;
};

function PieChartsMobileLightText({ text, additionalClassNames = "" }: PieChartsMobileLightTextProps) {
  return (
...
type PieCaptions114SpSubtitleTextProps = {
  text: string;
  additionalClassNames?: string;
};

function PieCaptions114SpSubtitleText({ text, additionalClassNames = "" }: PieCaptions114SpSubtitleTextProps) {
  return (
    <div className={clsx("-translate-x-1/2 -translate-y-1/2 absolute h-[24px] w-[62px]", additionalClassNames)}>
      <div className="absolute flex flex-col font-['IBM_Plex_Sans:Bold',sans-serif] inset-0 justify-center leading-[0] not-italic text-[#f5c324] text-[14px] text-center tracking-[0.1px]">
        <p className="leading-[24px]">{text}</p>
      </div>
    </div>
  );
...
type PieCaptions14SpSubtitleTextProps = {
  text: string;
  additionalClassNames?: string;
};

function PieCaptions14SpSubtitleText({ text, additionalClassNames = "" }: PieCaptions14SpSubtitleTextProps) {
  return (
    <div className={clsx("-translate-x-1/2 -translate-y-1/2 absolute h-[24px] w-[62px]", additionalClassNames)}>
...
export default function PieChartsMobileLight() {
  return (
    <div className="overflow-clip relative rounded-[8px] shadow-[0px_16px_32px_0px_rgba(176,190,197,0.24),0px_4px_8px_0px_rgba(176,190,197,0.48)] size-full" data-name="Pie Charts Mobile Light">
      ...
      <PieChartsMobileLightText text="omg!" additionalClassNames="left-[73.89%] right-[4.44%]" />
      <PieChartsMobileLightText text="Fast" additionalClassNames="left-[50.83%] right-[27.5%]" />
      <PieChartsMobileLightText text="med" additionalClassNames="left-[27.5%] right-[50.83%]" />
      <PieChartsMobileLightText text="low" additionalClassNames="left-[4.44%] right-[73.89%]" />
      <div className="absolute bottom-[90px] h-[16px] left-[73.89%] right-[4.44%]" data-name="Heatmap 75-100%">
        <div className="absolute bg-[#263238] inset-0" data-name="BG primary" />
      </div>
      ...
      <div className="-translate-x-1/2 -translate-y-1/2 absolute left-[calc(75%-4px)] size-[156px] top-[calc(50%-159px)]" data-name="Pie Gray">
        ...
        <div className="absolute bottom-1/2 left-1/2 opacity-24 right-0 top-[14.74%]" data-name="25,0 %">
          <PieChartsMobileLightFill />
        </div>
        <div className="absolute bottom-1/2 flex items-center justify-center left-1/2 right-[14.74%] top-0">
          <div className="-rotate-90 -scale-y-100 flex-none h-[55px] w-[78px]">
      ...
      <PieChartsMobileLight16SpBodyText text="Filled exclusion" additionalClassNames="left-[calc(25%+4px)] top-[calc(50%-53px)]" />
      <PieChartsMobileLight16SpBodyText text="Color play" additionalClassNames="left-[calc(25%+4px)] top-[calc(50%+175px)]" />
      <PieChartsMobileLight16SpBodyText text="Toggle blending" additionalClassNames="left-[calc(75%-4px)] top-[calc(50%-53px)]" />
      <div className="-translate-x-1/2 -translate-y-1/2 absolute h-[175px] left-[calc(25%+8px)] overflow-clip top-[calc(50%-168.5px)] w-[164px]" data-name="Pie & Captions">
        ...
        <PieCaptions14SpSubtitleText text="Salary" additionalClassNames="left-[calc(50%-36px)] top-[calc(50%+45.5px)]" />
        <PieCaptions14SpSubtitleText text="Sales" additionalClassNames="left-[calc(50%+35px)] top-[calc(50%+9.5px)]" />
        <div className="-translate-x-1/2 -translate-y-1/2 absolute h-[24px] left-[calc(50%+51px)] top-[calc(50%-75.5px)] w-[62px]" data-name="14 sp • Subtitle 2">
          <div className="absolute flex flex-col font-['IBM_Plex_Sans:Bold',sans-serif] inset-0 justify-center leading-[0] not-italic text-[#855cf8] text-[14px] text-center tracking-[0.1px]">
      ...
      <div className="-translate-x-1/2 -translate-y-1/2 absolute left-[calc(25%+4px)] overflow-clip size-[156px] top-[calc(50%+69px)]" data-name="Pie & Captions">
        ...
        <PieCaptions114SpSubtitleText text="Sketch" additionalClassNames="left-[calc(50%-32px)] top-[calc(50%-22px)]" />
        <PieCaptions114SpSubtitleText text="Figma" additionalClassNames="left-1/2 top-[calc(50%+56px)]" />
        <PieCaptions114SpSubtitleText text="XD" additionalClassNames="left-[calc(50%+31px)] top-[calc(50%-41px)]" />
      </div>
      ...
      <div className="absolute bottom-0 h-[48px] left-0 right-0" data-name="Mobile & Tablet / Bars / Tab">
        ...
        <div className="-translate-y-1/2 absolute h-[48px] left-[8px] overflow-clip right-[8px] top-1/2" data-name="Tabs">
          ...
          <div className="absolute bg-[#e9f0f7] inset-[8.33%_81.4%_8.33%_0] overflow-clip rounded-[4px]" data-name="Tab">
            ...
            <p className="-translate-x-1/2 absolute capitalize font-['IBM_Plex_Sans:Regular',sans-serif] leading-[16px] left-1/2 not-italic text-[#2e86de] text-[12px] text-center top-[calc(50%+2px)] tracking-[0.4px] whitespace-nowrap">Home</p>
          </div>
          ...
          <div className="-translate-y-1/2 absolute h-[30px] left-[8px] rounded-[20px] top-1/2" data-name="Master">
            <div className="flex flex-row items-center overflow-clip rounded-[inherit] size-full">
              <div className="content-stretch flex gap-[8px] h-full items-center relative">
                <p className="font-['IBM_Plex_Sans:Medium',sans-serif] leading-[1.28] not-italic relative shrink-0 text-[#263238] text-[20px] tracking-[0.15px] whitespace-nowrap">Income</p>
              </div>
            </div>
          </div>
        </div>
