...
import svgPaths from "./svg-yettqi2u0k";
type BubbleMobileDarkIconProps = {
  additionalClassNames?: string;
};

function BubbleMobileDarkIcon({ children, additionalClassNames = "" }: React.PropsWithChildren<BubbleMobileDarkIconProps>) {
  return (
...
function BubbleMobileDarkMobileTabletHeaderLeftLabel({ children }: React.PropsWithChildren<{}>) {
  return (
...
type BubbleMobileDarkTextProps = {
  text: string;
  additionalClassNames?: string;
};

function BubbleMobileDarkText({ text, additionalClassNames = "" }: BubbleMobileDarkTextProps) {
  return (
...
type BubbleMobileDarkLineRegularProps = {
  additionalClassNames?: string;
};

function BubbleMobileDarkLineRegular({ additionalClassNames = "" }: BubbleMobileDarkLineRegularProps) {
  return (
    <div className={clsx("absolute h-0 left-0 opacity-12 right-0", additionalClassNames)}>
      <div className="absolute inset-[-1px_0_0_0]">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 328 1">
          <line id="Line" stroke="var(--stroke-0, white)" x2="328" y1="0.5" y2="0.5" />
        </svg>
      </div>
    </div>
  );
...
export default function BubbleMobileDark() {
  return (
    <div className="overflow-clip relative rounded-[8px] size-full" data-name="Bubble Mobile Dark">
      ...
      <div className="absolute bg-[#2e2e33] inset-[56px_16px_110px_16px] overflow-clip" data-name="Right · 56dp">
        <BubbleMobileDarkLineRegular additionalClassNames="top-[56px]" />
        <BubbleMobileDarkLineRegular additionalClassNames="top-[112px]" />
        <BubbleMobileDarkLineRegular additionalClassNames="top-[168px]" />
        <BubbleMobileDarkLineRegular additionalClassNames="top-[224px]" />
        <BubbleMobileDarkLineRegular additionalClassNames="top-[280px]" />
        <BubbleMobileDarkLineRegular additionalClassNames="top-[336px]" />
        <BubbleMobileDarkLineRegular additionalClassNames="top-[504px]" />
        <BubbleMobileDarkLineRegular additionalClassNames="top-[560px]" />
        <BubbleMobileDarkLineRegular additionalClassNames="top-[616px]" />
        <BubbleMobileDarkLineRegular additionalClassNames="top-[672px]" />
        <BubbleMobileDarkLineRegular additionalClassNames="top-[728px]" />
        <BubbleMobileDarkLineRegular additionalClassNames="top-[392px]" />
        <BubbleMobileDarkLineRegular additionalClassNames="top-[448px]" />
        <BubbleMobileDarkLineRegular additionalClassNames="top-[840px]" />
        <BubbleMobileDarkLineRegular additionalClassNames="top-[896px]" />
        <BubbleMobileDarkLineRegular additionalClassNames="top-[952px]" />
        <BubbleMobileDarkLineRegular additionalClassNames="top-[1008px]" />
        <BubbleMobileDarkLineRegular additionalClassNames="top-[1064px]" />
        <BubbleMobileDarkLineRegular additionalClassNames="top-[784px]" />
        <BubbleMobileDarkText text="10 k" additionalClassNames="top-[4px]" />
        <BubbleMobileDarkText text="5 k" additionalClassNames="top-[60px]" />
        <BubbleMobileDarkText text="1 k" additionalClassNames="top-[116px]" />
        <BubbleMobileDarkText text="500" additionalClassNames="top-[172px]" />
        <BubbleMobileDarkText text="250" additionalClassNames="top-[228px]" />
        <BubbleMobileDarkText text="125" additionalClassNames="top-[284px]" />
        <BubbleMobileDarkText text="75" additionalClassNames="top-[340px]" />
        <BubbleMobileDarkText text="0" additionalClassNames="top-[676px]" />
        <BubbleMobileDarkText text="50" additionalClassNames="top-[396px]" />
        <BubbleMobileDarkText text="25" additionalClassNames="top-[452px]" />
        <BubbleMobileDarkText text="15" additionalClassNames="top-[508px]" />
        <BubbleMobileDarkText text="10" additionalClassNames="top-[564px]" />
        <BubbleMobileDarkText text="5" additionalClassNames="top-[620px]" />
        <BubbleMobileDarkText text="0" additionalClassNames="top-[956px]" />
        <BubbleMobileDarkText text="0" additionalClassNames="top-[1012px]" />
        <BubbleMobileDarkText text="25" additionalClassNames="top-[732px]" />
        <BubbleMobileDarkText text="15" additionalClassNames="top-[788px]" />
        <BubbleMobileDarkText text="10" additionalClassNames="top-[844px]" />
        <BubbleMobileDarkText text="5" additionalClassNames="top-[900px]" />
      </div>
      ...
      <div className="-translate-x-1/2 -translate-y-1/2 absolute contents left-[calc(37.5%+37px)] top-[calc(50%-15px)]" data-name="Bubbles">
        ...
        <div className="-translate-x-1/2 -translate-y-1/2 absolute left-[calc(50%-1px)] size-[64px] top-[calc(50%+91px)]" data-name="Bubble Purple">
          <div className="absolute inset-0 opacity-56" data-name="🎨 Colors Primary">
            <div className="absolute bg-[#1dd1a1] inset-0 rounded-[99px]" data-name="BG primary" />
          </div>
      ...
      <div className="absolute bottom-0 h-[48px] left-0 right-0" data-name="Header / Mobile & Tablet">
        ...
        <div className="absolute inset-[0_calc(33.33%-64px)]" data-name="Mobile & Tablet / Header / Center / Label">
          ...
          <Master additionalClassNames="-translate-x-1/2 h-[40px] left-[calc(50%-6px)]">
            <div className="relative shrink-0 size-[24px]" data-name="Left Icon">
              <BubbleMobileDarkIcon additionalClassNames="inset-[13.72%_30.39%_13.72%_27.44%]">
                <path clipRule="evenodd" d={svgPaths.p25748980} fill="var(--fill-0, #D3DDE7)" fillRule="evenodd" id="icon" />
              </BubbleMobileDarkIcon>
            </div>
            <p className="font-['IBM_Plex_Sans:Regular',sans-serif] leading-[24px] not-italic relative shrink-0 text-[#feca57] text-[16px] tracking-[0.44px] whitespace-nowrap">Yearly Bubbles</p>
            <div className="relative shrink-0 size-[24px]" data-name="Right Icon">
              <BubbleMobileDarkIcon additionalClassNames="inset-[13.72%_27.44%_13.72%_30.39%]">
                <path clipRule="evenodd" d={svgPaths.p1458aa00} fill="var(--fill-0, #D3DDE7)" fillRule="evenodd" id="icon" />
              </BubbleMobileDarkIcon>
            </div>
          </Master>
        </div>
        <div className="absolute inset-[0_0_0_calc(66.67%+64px)]" data-name="Mobile & Tablet / Header / Right / Label">
          ...
          <Master additionalClassNames="h-[30px] right-[-25px]">
            <p className="font-['IBM_Plex_Sans:Regular',sans-serif] leading-[24px] not-italic relative shrink-0 text-[16px] text-right text-white tracking-[0.44px] whitespace-nowrap">Details</p>
          </Master>
        </div>
        <BubbleMobileDarkMobileTabletHeaderLeftLabel>
          <p className="font-['IBM_Plex_Sans:Regular',sans-serif] leading-[24px] not-italic relative shrink-0 text-[16px] text-white tracking-[0.44px] whitespace-nowrap">Back</p>
        </BubbleMobileDarkMobileTabletHeaderLeftLabel>
        <div className="absolute contents left-0 right-full top-0" data-name="Dividers">
          <div className="absolute bg-[#171719] h-px left-0 right-0 top-0" data-name="Divider Top" />
        </div>
      </div>
      <div className="absolute h-[48px] left-0 right-0 top-0" data-name="Header / Mobile & Tablet">
        ...
        <BubbleMobileDarkMobileTabletHeaderLeftLabel>
          <p className="font-['IBM_Plex_Sans:Medium',sans-serif] leading-[1.28] not-italic relative shrink-0 text-[20px] text-white tracking-[0.15px] whitespace-nowrap">Top reposters</p>
        </BubbleMobileDarkMobileTabletHeaderLeftLabel>
        <div className="absolute contents left-0 right-full top-0" data-name="Dividers">
