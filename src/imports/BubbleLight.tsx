...
type BubbleLightTextProps = {
  text: string;
  additionalClassNames?: string;
};

function BubbleLightText({ text, additionalClassNames = "" }: BubbleLightTextProps) {
  return (
...
type BubbleLightHelperProps = {
  additionalClassNames?: string;
};

function BubbleLightHelper({ additionalClassNames = "" }: BubbleLightHelperProps) {
  return (
        ...
        <div className="opacity-12 relative size-full" data-name="Line Regular">
          <div className="absolute inset-[-1px_0_0_0]">
            <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 578 1">
              <line id="Line" stroke="var(--stroke-0, #263238)" x2="578" y1="0.5" y2="0.5" />
            </svg>
          </div>
        </div>
      </div>
...
export default function BubbleLight() {
  return (
    <div className="overflow-clip relative rounded-[8px] shadow-[0px_16px_32px_0px_rgba(176,190,197,0.24),0px_4px_8px_0px_rgba(176,190,197,0.48)] size-full" data-name="Bubble Light">
      ...
      <div className="absolute inset-[88px_24px_70px_24px] overflow-clip" data-name="Bottom · 56dp">
        <BubbleLightHelper additionalClassNames="left-[80px]" />
        <BubbleLightHelper additionalClassNames="left-[192px]" />
        <BubbleLightHelper additionalClassNames="left-[304px]" />
        <BubbleLightHelper additionalClassNames="left-[416px]" />
        <BubbleLightHelper additionalClassNames="left-[528px]" />
        <BubbleLightHelper additionalClassNames="left-[640px]" />
        <BubbleLightHelper additionalClassNames="left-[752px]" />
        <BubbleLightHelper additionalClassNames="left-[808px]" />
        <BubbleLightHelper additionalClassNames="left-[864px]" />
        <BubbleLightHelper additionalClassNames="left-[920px]" />
        <BubbleLightHelper additionalClassNames="left-[976px]" />
        <BubbleLightHelper additionalClassNames="left-[1032px]" />
        <BubbleLightHelper additionalClassNames="left-[1088px]" />
        <BubbleLightHelper additionalClassNames="left-[1144px]" />
        <BubbleLightHelper additionalClassNames="left-[1200px]" />
        <BubbleLightHelper additionalClassNames="left-[1256px]" />
        <BubbleLightHelper additionalClassNames="left-[1312px]" />
        <BubbleLightHelper additionalClassNames="left-[1368px]" />
        <BubbleLightText text="aug" additionalClassNames="left-[392px]" />
        <BubbleLightText text="oct" additionalClassNames="left-[504px]" />
        <BubbleLightText text="dec" additionalClassNames="left-[616px]" />
        <BubbleLightText text="feb" additionalClassNames="left-[728px]" />
        <BubbleLightText text="mar" additionalClassNames="left-[784px]" />
        <BubbleLightText text="jul" additionalClassNames="left-[840px]" />
        <BubbleLightText text="aug" additionalClassNames="left-[896px]" />
        <BubbleLightText text="sep" additionalClassNames="left-[952px]" />
        <BubbleLightText text="oct" additionalClassNames="left-[1008px]" />
        <BubbleLightText text="nov" additionalClassNames="left-[1064px]" />
        <BubbleLightText text="dec" additionalClassNames="left-[1120px]" />
        <BubbleLightText text="jan" additionalClassNames="left-[1176px]" />
        <BubbleLightText text="feb" additionalClassNames="left-[1232px]" />
        <BubbleLightText text="mar" additionalClassNames="left-[1288px]" />
        <BubbleLightText text="feb" additionalClassNames="left-[56px]" />
        <BubbleLightText text="apr" additionalClassNames="left-[168px]" />
        <BubbleLightText text="jun" additionalClassNames="left-[280px]" />
      </div>
        ...
        <div className="absolute inset-[0_360px]" data-name="Center / Color Info">
          ...
          <div className="-translate-x-1/2 -translate-y-1/2 absolute content-stretch flex items-center left-1/2 overflow-clip top-1/2" data-name="Color Info">
            ...
            <div className="h-[24px] overflow-clip relative shrink-0 w-[112px]" data-name="🔶 Items/Color info Double">
              ...
              <ColorInfoBarBlue>
                <div className="absolute bg-[#263238] inset-0 rounded-[99px]" data-name="BG primary" />
              </ColorInfoBarBlue>
            </div>
            <div className="h-[24px] overflow-clip relative shrink-0 w-[112px]" data-name="🔶 Items/Color info Double">
